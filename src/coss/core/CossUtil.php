<?php
    ...
    class CossUtil
    {
        ...
        public const COSS_CONTENT = 'content';

        public const COSS_LENGTH = 'length';

        public const COSS_HEADERS = 'headers';

        public const COSS_MAX_OBJECT_GROUP_VALUE = 1000;

        public const COSS_MAX_PART_SIZE = 5368709120; // 5GB

        public const COSS_MID_PART_SIZE = 10485760; // 10MB

        public const COSS_MIN_PART_SIZE = 102400; // 100KB
        ...
        public static function validateObject($object)
        {
            ...
            return !(empty($object) || !preg_match($pattern, $object) ||
        ...
        public static function validateOptions($options)
        {
            ...
            if ($options != NULL && !is_array($options)) {
                throw new CossException ($options . ':' . 'option must be array');
            }
        }
        ...
        {
            if (empty($content)) {
                throw new CossException('http body content is invalid');
            }
        }
         ...
         * @throws CossException
         */
        public static function throwCossExceptionWithMessageIfEmpty($name, $errMsg)
        {
            if (empty($name)) {
                throw new CossException($errMsg);
            }
        }
...
BBB;
        ...
        {
            $content_md5 = '';
            if (($to_pos - $from_pos) > self::COSS_MAX_PART_SIZE) {
                return $content_md5;
            }
        ...
        public static function createDeleteObjectsXmlBody($objects, $quiet)
        {
            ...
            foreach ($objects as $object) {
                ...
                $object = CossUtil::sReplace($object);
        ...
        public static function decodeKey($key, $encoding)
        {
            ...
            throw new CossException('Unrecognized encoding type: ' . $encoding);
        }
